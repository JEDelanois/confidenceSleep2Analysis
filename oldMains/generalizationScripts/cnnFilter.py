...
import CnnFilter.CnnFilterMain
...
CnnFilter.CnnFilterMain.plotMetric([data, data], ["/stateDict/modelStateDict0.pth", "/stateDict/modelStateDict1.pth"], fileName="filter-Orthogonality.png", metricType="orthogonality", modelMemberName="model", legend=["Post Training", "Post Sleep"])
# CnnFilter.CnnFilterMain.plotMetric([data, data], ["/stateDict/modelStateDict0.pth", "/stateDict/modelStateDict1.pth"], fileName="filter-Sparsity.png", metricType="sparsity", modelMemberName="model", legend=["Post Training", "Post Sleep"])
# CnnFilter.CnnFilterMain.plotMetric([data, data], ["/stateDict/modelStateDict0.pth", "/stateDict/modelStateDict1.pth"], fileName="filter-Mean.png", metricType="getFilterMean", modelMemberName="model", legend=["Post Training", "Post Sleep"])
# CnnFilter.CnnFilterMain.plotMetric([data, data], ["/stateDict/modelStateDict0.pth", "/stateDict/modelStateDict1.pth"], fileName="filter-Std.png", metricType="getFilterStd", modelMemberName="model", legend=["Post Training", "Post Sleep"])
