...
# path = "../simulations/cifarBaselineSleeptest/1/" 
# name = "CIFAR"

# path = "/bazhlab/edelanois/confidence/0/GenAlgoHead-mnist/bestSimFolderLink/" 
# name = "MNIST"

path = "../simulations/mnistBaselineBestSleep0/" 
name = "MNIST"
...
dataGroups = [ 
    ["task1ValidData", "task1ValidData-ga"]
